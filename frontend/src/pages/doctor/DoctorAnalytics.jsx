      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          <motion.div key={idx} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.05 }}
            ...
            <div className="flex items-center gap-1.5 mt-3 text-xs font-semibold text-slate-500 dark:text-slate-400">
        ...
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800 shadow-sm rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center gap-4 text-[10px] font-bold text-slate-500 dark:text-slate-400">
